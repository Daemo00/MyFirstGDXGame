...
public class RenderingSystem extends SortedIteratingSystem {
    ...
    static final float FRUSTUM_HEIGHT = Gdx.graphics.getHeight() / PIXELS_PER_METRE;
    ...
    public static Vector2 getScreenSizeInMeters() {
        meterDimensions.set(Gdx.graphics.getWidth() * METRES_PER_PIXEL,
                Gdx.graphics.getHeight() * METRES_PER_PIXEL);
    ...
    public static float PixelsToMeters(float pixelValue) {
        return pixelValue * METRES_PER_PIXEL;
    }
